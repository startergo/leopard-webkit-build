...
template<> RsaOtherPrimesInfo convertDictionary<RsaOtherPrimesInfo>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (isNullOrUndefined)
        ...
        tValue = object->get(&lexicalGlobalObject, Identifier::fromString(vm, "t"));
        RETURN_IF_EXCEPTION(throwScope, { });
    }
...
JSC::JSObject* convertDictionaryToJS(JSC::JSGlobalObject& lexicalGlobalObject, JSDOMGlobalObject& globalObject, const RsaOtherPrimesInfo& dictionary)
{
    ...
    auto dValue = toJS<IDLDOMString>(lexicalGlobalObject, dictionary.d);
    result->putDirect(vm, JSC::Identifier::fromString(vm, "d"), dValue);
    auto rValue = toJS<IDLDOMString>(lexicalGlobalObject, dictionary.r);
    result->putDirect(vm, JSC::Identifier::fromString(vm, "r"), rValue);
    auto tValue = toJS<IDLDOMString>(lexicalGlobalObject, dictionary.t);
    result->putDirect(vm, JSC::Identifier::fromString(vm, "t"), tValue);
    return result;
}
