...
CallbackResult<typename IDLVoid::ImplementationType> JSMutationCallback::handleEvent(typename IDLInterface<MutationObserver>::ParameterType thisObject, typename IDLSequence<IDLInterface<MutationRecord>>::ParameterType mutations, typename IDLInterface<MutationObserver>::ParameterType observer)
{
