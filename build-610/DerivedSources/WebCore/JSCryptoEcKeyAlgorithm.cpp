...
JSC::JSObject* convertDictionaryToJS(JSC::JSGlobalObject& lexicalGlobalObject, JSDOMGlobalObject& globalObject, const CryptoEcKeyAlgorithm& dictionary)
{
    ...
    auto namedCurveValue = toJS<IDLDOMString>(lexicalGlobalObject, dictionary.namedCurve);
    result->putDirect(vm, JSC::Identifier::fromString(vm, "namedCurve"), namedCurveValue);
    return result;
}
