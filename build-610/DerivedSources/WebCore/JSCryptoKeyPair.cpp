...
template<> CryptoKeyPair convertDictionary<CryptoKeyPair>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (isNullOrUndefined)
        ...
        privateKeyValue = object->get(&lexicalGlobalObject, Identifier::fromString(vm, "privateKey"));
...
JSC::JSObject* convertDictionaryToJS(JSC::JSGlobalObject& lexicalGlobalObject, JSDOMGlobalObject& globalObject, const CryptoKeyPair& dictionary)
{
    ...
    if (!IDLInterface<CryptoKey>::isNullValue(dictionary.privateKey)) {
        auto privateKeyValue = toJS<IDLInterface<CryptoKey>>(lexicalGlobalObject, globalObject, IDLInterface<CryptoKey>::extractValueFromNullable(dictionary.privateKey));
    ...
    if (!IDLInterface<CryptoKey>::isNullValue(dictionary.publicKey)) {
        auto publicKeyValue = toJS<IDLInterface<CryptoKey>>(lexicalGlobalObject, globalObject, IDLInterface<CryptoKey>::extractValueFromNullable(dictionary.publicKey));
