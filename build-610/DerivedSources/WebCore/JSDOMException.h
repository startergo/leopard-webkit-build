...
public:
    ...
    {
        JSDOMException* ptr = new (NotNull, JSC::allocateCell<JSDOMException>(globalObject->vm().heap)) JSDOMException(structure, *globalObject, WTFMove(impl));
...
class JSDOMExceptionOwner : public JSC::WeakHandleOwner {
public:
