...
JSSQLTransactionCallback::JSSQLTransactionCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
    : SQLTransactionCallback(globalObject->scriptExecutionContext())
...
CallbackResult<typename IDLVoid::ImplementationType> JSSQLTransactionCallback::handleEvent(typename IDLInterface<SQLTransaction>::ParameterType transaction)
{
