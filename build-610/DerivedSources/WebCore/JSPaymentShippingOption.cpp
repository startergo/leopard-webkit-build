...
template<> PaymentShippingOption convertDictionary<PaymentShippingOption>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!amountValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "amount", "PaymentShippingOption", "PaymentCurrencyAmount");
        return { };
    }
    JSValue idValue;
    if (isNullOrUndefined)
    ...
    if (!idValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "id", "PaymentShippingOption", "DOMString");
        return { };
    }
    JSValue labelValue;
    if (isNullOrUndefined)
    ...
    if (!labelValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "label", "PaymentShippingOption", "DOMString");
        return { };
    }
    ...
    if (!selectedValue.isUndefined()) {
        result.selected = convert<IDLBoolean>(lexicalGlobalObject, selectedValue);
        RETURN_IF_EXCEPTION(throwScope, { });
    } else
