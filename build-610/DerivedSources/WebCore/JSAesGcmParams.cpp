...
template<> CryptoAlgorithmAesGcmParams convertDictionary<CryptoAlgorithmAesGcmParams>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (isNullOrUndefined)
        ...
        additionalDataValue = object->get(&lexicalGlobalObject, Identifier::fromString(vm, "additionalData"));
        RETURN_IF_EXCEPTION(throwScope, { });
    }
    ...
    if (isNullOrUndefined)
        ...
        ivValue = object->get(&lexicalGlobalObject, Identifier::fromString(vm, "iv"));
        RETURN_IF_EXCEPTION(throwScope, { });
    }
    ...
    if (isNullOrUndefined)
        ...
        tagLengthValue = object->get(&lexicalGlobalObject, Identifier::fromString(vm, "tagLength"));
        RETURN_IF_EXCEPTION(throwScope, { });
    }
