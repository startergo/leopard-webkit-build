...
public:
    ...
    static OESTextureHalfFloatLinear* toWrapped(JSC::VM&, JSC::JSValue);
...
JSC::JSValue toJS(JSC::JSGlobalObject*, JSDOMGlobalObject*, OESTextureHalfFloatLinear&);
inline JSC::JSValue toJS(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, OESTextureHalfFloatLinear* impl) { return impl ? toJS(lexicalGlobalObject, globalObject, *impl) : JSC::jsNull(); }
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject*, JSDOMGlobalObject*, Ref<OESTextureHalfFloatLinear>&&);
inline JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, RefPtr<OESTextureHalfFloatLinear>&& impl) { return impl ? toJSNewlyCreated(lexicalGlobalObject, globalObject, impl.releaseNonNull()) : JSC::jsNull(); }
