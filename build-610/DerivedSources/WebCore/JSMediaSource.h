...
public:
    ...
    static MediaSource* toWrapped(JSC::VM&, JSC::JSValue);
...
JSC::JSValue toJS(JSC::JSGlobalObject*, JSDOMGlobalObject*, MediaSource&);
inline JSC::JSValue toJS(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, MediaSource* impl) { return impl ? toJS(lexicalGlobalObject, globalObject, *impl) : JSC::jsNull(); }
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject*, JSDOMGlobalObject*, Ref<MediaSource>&&);
inline JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, RefPtr<MediaSource>&& impl) { return impl ? toJSNewlyCreated(lexicalGlobalObject, globalObject, impl.releaseNonNull()) : JSC::jsNull(); }
...
template<> JSC::JSString* convertEnumerationToJS(JSC::JSGlobalObject&, MediaSource::EndOfStreamError);

template<> Optional<MediaSource::EndOfStreamError> parseEnumeration<MediaSource::EndOfStreamError>(JSC::JSGlobalObject&, JSC::JSValue);
...
template<> JSC::JSString* convertEnumerationToJS(JSC::JSGlobalObject&, MediaSource::ReadyState);

template<> Optional<MediaSource::ReadyState> parseEnumeration<MediaSource::ReadyState>(JSC::JSGlobalObject&, JSC::JSValue);
