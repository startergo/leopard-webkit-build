...
public:
    ...
    static JSC::JSObject* serialize(JSC::JSGlobalObject&, JSMediaDeviceInfo& thisObject, JSDOMGlobalObject&, JSC::ThrowScope&);
...
JSC::JSValue toJS(JSC::JSGlobalObject*, JSDOMGlobalObject*, MediaDeviceInfo&);
inline JSC::JSValue toJS(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, MediaDeviceInfo* impl) { return impl ? toJS(lexicalGlobalObject, globalObject, *impl) : JSC::jsNull(); }
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject*, JSDOMGlobalObject*, Ref<MediaDeviceInfo>&&);
inline JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, RefPtr<MediaDeviceInfo>&& impl) { return impl ? toJSNewlyCreated(lexicalGlobalObject, globalObject, impl.releaseNonNull()) : JSC::jsNull(); }
...
template<> JSC::JSString* convertEnumerationToJS(JSC::JSGlobalObject&, MediaDeviceInfo::Kind);

template<> Optional<MediaDeviceInfo::Kind> parseEnumeration<MediaDeviceInfo::Kind>(JSC::JSGlobalObject&, JSC::JSValue);
