...
public:
    ...
    static WebGLShaderPrecisionFormat* toWrapped(JSC::VM&, JSC::JSValue);
...
JSC::JSValue toJS(JSC::JSGlobalObject*, JSDOMGlobalObject*, WebGLShaderPrecisionFormat&);
inline JSC::JSValue toJS(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, WebGLShaderPrecisionFormat* impl) { return impl ? toJS(lexicalGlobalObject, globalObject, *impl) : JSC::jsNull(); }
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject*, JSDOMGlobalObject*, Ref<WebGLShaderPrecisionFormat>&&);
inline JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, RefPtr<WebGLShaderPrecisionFormat>&& impl) { return impl ? toJSNewlyCreated(lexicalGlobalObject, globalObject, impl.releaseNonNull()) : JSC::jsNull(); }
