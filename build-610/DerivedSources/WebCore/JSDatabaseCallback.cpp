...
JSDatabaseCallback::JSDatabaseCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
    : DatabaseCallback(globalObject->scriptExecutionContext())
...
CallbackResult<typename IDLVoid::ImplementationType> JSDatabaseCallback::handleEvent(typename IDLInterface<Database>::ParameterType database)
{
    ...
    args.append(toJS<IDLInterface<Database>>(lexicalGlobalObject, globalObject, database));
