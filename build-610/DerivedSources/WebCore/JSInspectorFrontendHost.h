...
template<> InspectorFrontendHost::ContextMenuItem convertDictionary<InspectorFrontendHost::ContextMenuItem>(JSC::JSGlobalObject&, JSC::JSValue);

template<> InspectorFrontendHost::DebuggableInfo convertDictionary<InspectorFrontendHost::DebuggableInfo>(JSC::JSGlobalObject&, JSC::JSValue);
