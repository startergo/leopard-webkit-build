...
class JSHTMLMarqueeElementOwner : public JSNodeOwner {
public:
    virtual bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::SlotVisitor&, const char**);
    virtual void finalize(JSC::Handle<JSC::Unknown>, void* context);
};

inline JSC::WeakHandleOwner* wrapperOwner(DOMWrapperWorld&, HTMLMarqueeElement*)
{
    static NeverDestroyed<JSHTMLMarqueeElementOwner> owner;
    return &owner.get();
}

inline void* wrapperKey(HTMLMarqueeElement* wrappableObject)
{
