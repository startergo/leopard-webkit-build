...
JSSQLTransactionErrorCallback::JSSQLTransactionErrorCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
    : SQLTransactionErrorCallback(globalObject->scriptExecutionContext())
...
CallbackResult<typename IDLVoid::ImplementationType> JSSQLTransactionErrorCallback::handleEvent(typename IDLInterface<SQLError>::ParameterType error)
{
