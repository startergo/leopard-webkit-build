...
const ClassInfo JSWebGLVertexArrayObjectOESPrototype::s_info = { "WebGLVertexArrayObjectOES", &Base::s_info, nullptr, nullptr, CREATE_METHOD_TABLE(JSWebGLVertexArrayObjectOESPrototype) };
...
const ClassInfo JSWebGLVertexArrayObjectOES::s_info = { "WebGLVertexArrayObjectOES", &Base::s_info, nullptr, nullptr, CREATE_METHOD_TABLE(JSWebGLVertexArrayObjectOES) };
...
JSC::IsoSubspace* JSWebGLVertexArrayObjectOES::subspaceForImpl(JSC::VM& vm)
{
    auto& clientData = *static_cast<JSVMClientData*>(vm.clientData);
    auto& spaces = clientData.subspaces();
    if (auto* space = spaces.m_subspaceForWebGLVertexArrayObjectOES.get())
        return space;
    static_assert(std::is_base_of_v<JSC::JSDestructibleObject, JSWebGLVertexArrayObjectOES> || !JSWebGLVertexArrayObjectOES::needsDestruction);
    if constexpr (std::is_base_of_v<JSC::JSDestructibleObject, JSWebGLVertexArrayObjectOES>)
        spaces.m_subspaceForWebGLVertexArrayObjectOES = makeUnique<IsoSubspace> ISO_SUBSPACE_INIT(vm.heap, vm.destructibleObjectHeapCellType.get(), JSWebGLVertexArrayObjectOES);
    else
        spaces.m_subspaceForWebGLVertexArrayObjectOES = makeUnique<IsoSubspace> ISO_SUBSPACE_INIT(vm.heap, vm.cellHeapCellType.get(), JSWebGLVertexArrayObjectOES);
    auto* space = spaces.m_subspaceForWebGLVertexArrayObjectOES.get();
IGNORE_WARNINGS_BEGIN("unreachable-code")
IGNORE_WARNINGS_BEGIN("tautological-compare")
    if (&JSWebGLVertexArrayObjectOES::visitOutputConstraints != &JSC::JSCell::visitOutputConstraints)
...
bool JSWebGLVertexArrayObjectOESOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, SlotVisitor& visitor, const char** reason)
{
    UNUSED_PARAM(handle);
...
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject*, JSDOMGlobalObject* globalObject, Ref<WebGLVertexArrayObjectOES>&& impl)
{
    ...
    static_assert(std::is_polymorphic<WebGLVertexArrayObjectOES>::value, "WebGLVertexArrayObjectOES is not polymorphic");
...
WebGLVertexArrayObjectOES* JSWebGLVertexArrayObjectOES::toWrapped(JSC::VM& vm, JSC::JSValue value)
{
    if (auto* wrapper = jsDynamicCast<JSWebGLVertexArrayObjectOES*>(vm, value))
