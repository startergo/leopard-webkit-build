...
JSSQLStatementCallback::JSSQLStatementCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
    : SQLStatementCallback(globalObject->scriptExecutionContext())
...
CallbackResult<typename IDLVoid::ImplementationType> JSSQLStatementCallback::handleEvent(typename IDLInterface<SQLTransaction>::ParameterType transaction, typename IDLInterface<SQLResultSet>::ParameterType resultSet)
{
    ...
    args.append(toJS<IDLInterface<SQLResultSet>>(lexicalGlobalObject, globalObject, resultSet));
