...
const ClassInfo JSOESTextureFloatLinearPrototype::s_info = { "OESTextureFloatLinear", &Base::s_info, nullptr, nullptr, CREATE_METHOD_TABLE(JSOESTextureFloatLinearPrototype) };
...
JSC::IsoSubspace* JSOESTextureFloatLinear::subspaceForImpl(JSC::VM& vm)
{
    auto& clientData = *static_cast<JSVMClientData*>(vm.clientData);
    auto& spaces = clientData.subspaces();
    if (auto* space = spaces.m_subspaceForOESTextureFloatLinear.get())
        return space;
    static_assert(std::is_base_of_v<JSC::JSDestructibleObject, JSOESTextureFloatLinear> || !JSOESTextureFloatLinear::needsDestruction);
    if constexpr (std::is_base_of_v<JSC::JSDestructibleObject, JSOESTextureFloatLinear>)
        spaces.m_subspaceForOESTextureFloatLinear = makeUnique<IsoSubspace> ISO_SUBSPACE_INIT(vm.heap, vm.destructibleObjectHeapCellType.get(), JSOESTextureFloatLinear);
    else
        spaces.m_subspaceForOESTextureFloatLinear = makeUnique<IsoSubspace> ISO_SUBSPACE_INIT(vm.heap, vm.cellHeapCellType.get(), JSOESTextureFloatLinear);
    auto* space = spaces.m_subspaceForOESTextureFloatLinear.get();
IGNORE_WARNINGS_BEGIN("unreachable-code")
IGNORE_WARNINGS_BEGIN("tautological-compare")
    if (&JSOESTextureFloatLinear::visitOutputConstraints != &JSC::JSCell::visitOutputConstraints)
