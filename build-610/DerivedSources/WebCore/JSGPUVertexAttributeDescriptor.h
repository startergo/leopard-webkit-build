...
template<> GPUVertexAttributeDescriptor convertDictionary<GPUVertexAttributeDescriptor>(JSC::JSGlobalObject&, JSC::JSValue);
...
template<> Optional<GPUVertexFormat> parseEnumeration<GPUVertexFormat>(JSC::JSGlobalObject&, JSC::JSValue);
