...
CallbackResult<typename IDLVoid::ImplementationType> JSPositionErrorCallback::handleEvent(typename IDLInterface<GeolocationPositionError>::ParameterType error)
{
    ...
    args.append(toJS<IDLInterface<GeolocationPositionError>>(lexicalGlobalObject, globalObject, error));
