...
public:
    ...
    {
        JSClipboardItem* ptr = new (NotNull, JSC::allocateCell<JSClipboardItem>(globalObject->vm().heap)) JSClipboardItem(structure, *globalObject, WTFMove(impl));
...
class JSClipboardItemOwner : public JSC::WeakHandleOwner {
public:
...
template<> JSC::JSString* convertEnumerationToJS(JSC::JSGlobalObject&, ClipboardItem::PresentationStyle);

template<> Optional<ClipboardItem::PresentationStyle> parseEnumeration<ClipboardItem::PresentationStyle>(JSC::JSGlobalObject&, JSC::JSValue);
template<> const char* expectedEnumerationValues<ClipboardItem::PresentationStyle>();

template<> ClipboardItem::Options convertDictionary<ClipboardItem::Options>(JSC::JSGlobalObject&, JSC::JSValue);
