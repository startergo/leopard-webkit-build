...
public:
    ...
    {
        JSPerformanceObserverEntryList* ptr = new (NotNull, JSC::allocateCell<JSPerformanceObserverEntryList>(globalObject->vm().heap)) JSPerformanceObserverEntryList(structure, *globalObject, WTFMove(impl));
    ...
    static PerformanceObserverEntryList* toWrapped(JSC::VM&, JSC::JSValue);
...
class JSPerformanceObserverEntryListOwner : public JSC::WeakHandleOwner {
public:
