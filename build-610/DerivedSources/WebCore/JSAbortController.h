...
public:
    ...
    {
        JSAbortController* ptr = new (NotNull, JSC::allocateCell<JSAbortController>(globalObject->vm().heap)) JSAbortController(structure, *globalObject, WTFMove(impl));
...
class JSAbortControllerOwner : public JSC::WeakHandleOwner {
public:
