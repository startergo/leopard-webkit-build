...
class JSPositionCallback final : public PositionCallback {
public:
    ...
    // Functions
    CallbackResult<typename IDLVoid::ImplementationType> handleEvent(typename IDLNullable<IDLInterface<GeolocationPosition>>::ParameterType position) override;
