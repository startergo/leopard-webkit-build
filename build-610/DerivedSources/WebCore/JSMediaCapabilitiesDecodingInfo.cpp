...
template<> MediaCapabilitiesDecodingInfo convertDictionary<MediaCapabilitiesDecodingInfo>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    MediaCapabilitiesDecodingInfo result;
    ...
    if (!powerEfficientValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "powerEfficient", "MediaCapabilitiesDecodingInfo", "boolean");
        return { };
    }
    JSValue smoothValue;
    if (isNullOrUndefined)
    ...
    if (!smoothValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "smooth", "MediaCapabilitiesDecodingInfo", "boolean");
        return { };
    }
    ...
    if (!supportedValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "supported", "MediaCapabilitiesDecodingInfo", "boolean");
        return { };
    }
    ...
    if (!supportedConfigurationValue.isUndefined()) {
        result.supportedConfiguration = convert<IDLDictionary<MediaDecodingConfiguration>>(lexicalGlobalObject, supportedConfigurationValue);
        RETURN_IF_EXCEPTION(throwScope, { });
    }
    return result;
}
...
JSC::JSObject* convertDictionaryToJS(JSC::JSGlobalObject& lexicalGlobalObject, JSDOMGlobalObject& globalObject, const MediaCapabilitiesDecodingInfo& dictionary)
{
    ...
    if (downcast<Document>(jsCast<JSDOMGlobalObject*>(&globalObject)->scriptExecutionContext())->settings().mediaCapabilitiesExtensionsEnabled()) {
        if (!IDLDictionary<MediaDecodingConfiguration>::isNullValue(dictionary.supportedConfiguration)) {
            auto supportedConfigurationValue = toJS<IDLDictionary<MediaDecodingConfiguration>>(lexicalGlobalObject, globalObject, IDLDictionary<MediaDecodingConfiguration>::extractValueFromNullable(dictionary.supportedConfiguration));
