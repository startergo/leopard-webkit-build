...
template<> JSC::JSString* convertEnumerationToJS(JSC::JSGlobalObject&, MediaControlsHost::DeviceType);

template<> Optional<MediaControlsHost::DeviceType> parseEnumeration<MediaControlsHost::DeviceType>(JSC::JSGlobalObject&, JSC::JSValue);
