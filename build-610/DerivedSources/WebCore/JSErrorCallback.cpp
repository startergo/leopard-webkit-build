...
JSErrorCallback::JSErrorCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
    : ErrorCallback(globalObject->scriptExecutionContext())
...
CallbackResult<typename IDLVoid::ImplementationType> JSErrorCallback::handleEvent(typename IDLInterface<DOMException>::ParameterType error)
{
