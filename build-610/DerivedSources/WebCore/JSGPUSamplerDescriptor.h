...
template<> GPUSamplerDescriptor convertDictionary<GPUSamplerDescriptor>(JSC::JSGlobalObject&, JSC::JSValue);
...
template<> Optional<GPUAddressMode> parseEnumeration<GPUAddressMode>(JSC::JSGlobalObject&, JSC::JSValue);
...
template<> Optional<GPUFilterMode> parseEnumeration<GPUFilterMode>(JSC::JSGlobalObject&, JSC::JSValue);
