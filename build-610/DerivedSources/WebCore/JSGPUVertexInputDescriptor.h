...
template<> GPUVertexInputDescriptor convertDictionary<GPUVertexInputDescriptor>(JSC::JSGlobalObject&, JSC::JSValue);
...
template<> Optional<GPUIndexFormat> parseEnumeration<GPUIndexFormat>(JSC::JSGlobalObject&, JSC::JSValue);
