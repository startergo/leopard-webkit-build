...
public:
    ...
    {
        JSReadableStreamBYOBRequest* ptr = new (NotNull, JSC::allocateCell<JSReadableStreamBYOBRequest>(globalObject->vm().heap)) JSReadableStreamBYOBRequest(structure, *globalObject);
