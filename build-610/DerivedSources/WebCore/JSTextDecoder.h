...
JSC::JSValue toJS(JSC::JSGlobalObject*, JSDOMGlobalObject*, TextDecoder&);
inline JSC::JSValue toJS(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, TextDecoder* impl) { return impl ? toJS(lexicalGlobalObject, globalObject, *impl) : JSC::jsNull(); }
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject*, JSDOMGlobalObject*, Ref<TextDecoder>&&);
inline JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, RefPtr<TextDecoder>&& impl) { return impl ? toJSNewlyCreated(lexicalGlobalObject, globalObject, impl.releaseNonNull()) : JSC::jsNull(); }
...
template<> TextDecoder::Options convertDictionary<TextDecoder::Options>(JSC::JSGlobalObject&, JSC::JSValue);

template<> TextDecoder::DecodeOptions convertDictionary<TextDecoder::DecodeOptions>(JSC::JSGlobalObject&, JSC::JSValue);
