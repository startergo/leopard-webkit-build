...
CallbackResult<typename IDLVoid::ImplementationType> JSPerformanceObserverCallback::handleEvent(typename IDLInterface<PerformanceObserverEntryList>::ParameterType entries, typename IDLInterface<PerformanceObserver>::ParameterType observer)
{
