...
public:
    ...
    {
        JSClipboard* ptr = new (NotNull, JSC::allocateCell<JSClipboard>(globalObject->vm().heap)) JSClipboard(structure, *globalObject, WTFMove(impl));
    ...
    static Clipboard* toWrapped(JSC::VM&, JSC::JSValue);
