// [leopard-webkit-build] Overlay copy of <Foundation/NSSet.h> with ObjC lightweight
...
@interface NSSet<__covariant ObjectType> : NSObject <NSCopying, NSMutableCopying, NSCoding, NSFastEnumeration>
