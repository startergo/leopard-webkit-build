// [leopard-webkit-build] Overlay copy of <Foundation/NSArray.h> with ObjC lightweight
...
@interface NSArray<__covariant ObjectType> : NSObject <NSCopying, NSMutableCopying, NSCoding, NSFastEnumeration>
