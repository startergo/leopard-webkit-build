// [leopard-webkit-build] Overlay copy of <Foundation/NSDictionary.h> with ObjC lightweight
// generics added to the base collection classes so WebKit 610's NSArray<X> /
// NSDictionary<K,V> / NSSet<X> annotations parse. Derived from the 10.6 SDK
// header (SDK left untouched). Generics are compile-time only; no runtime effect.
/*	NSDictionary.h
...
@interface NSDictionary<__covariant KeyType, __covariant ObjectType> : NSObject <NSCopying, NSMutableCopying, NSCoding, NSFastEnumeration>
